...
CTX = {"batch": "demo-batch", "batch_file": "/absolute/path/to/batches/demo-batch.json", "home": None,
       "python": "python3", "runner": "/absolute/path/to/linear-runner/runner.py", "owner": "@owner-handle",
...
def samples():
    ...
    items = [
        ...
        ("Done", "done.md", "runner", "after Done is published and read back", "TEAM-12", "done",
         messages.done(CTX, issue="TEAM-12", commit="4c44464d4ce9a0b1", criteria_count=3, repairs=1, run_dir=RUN)),
        ("Blocked or stopped, with the worker's blocked note", "blocked.md + draft-blocked.md", "runner (quotes the worker)",
         "when the batch pauses; the owner is mentioned and notified", "TEAM-12", "blocked",
...
def render_document():
    lines = ["# Linear comment samples (DRAFT wording)", "",
